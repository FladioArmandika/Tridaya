  ...
  <div class="col s12 m12">    
    <div class="card">    
      <div class="card-content" style="padding:50px 150px 50px 150px;">     
        <span class="card-title cmp-title">TAMBAH PENGAJAR</span> <br>  
      	<div class="row" style="text-align: left !important;">   
      		<c:choose>
				<c:when test="${editform == 'true'}">
    				<form:form class="row" action="${pageContext.request.contextPath}/pengajar/update/${editmodel.id}" modelAttribute="pengajar" method="POST">     	
						<div class="col s7">       
			    			<div class="row"> 
							...
							<div class="row">
						        <div class="input-field col s10">   
						          <input type="date" class="datepicker" name="tgl_lahir" value="${editmodel.tgl_lahir}">
				...
				<c:otherwise>
					<form:form class="row" action="${pageContext.request.contextPath}/pengajar/tambah" modelAttribute="siswa" method="POST">     	
						<div class="col s7">       
			    			<div class="row"> 
						        <div class="input-field col s10">
